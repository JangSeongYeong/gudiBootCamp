...
public class Main {
	...
	public static void main(String[] args) {
		...
		// ^x : x 로 시작하는...(문자열의 시작)
		System.out.println("^x : x 로 시작하는...(문자열의 시작)");
		...
		System.out.println("xlist : "+result);
 		...
 		// x$ : x 로 끝나는 ... (문자열 종료)
 		System.out.println("x$ : x 로 끝나는 ... (문자열 종료)");
 		...
 		// x* : x 가 있을수도 있고 없을 수도 있고 반복될 수도 있다.
 		System.out.println("x* : x 가 있을수도 있고 없을 수도 있고 반복될 수도 있다.");
 		...
 		// x* : x 가 있을수도 있고 없을 수도 있고 반복될 수도 있다.
 		System.out.println("x? : x 가 있을수도 있지만 없을 수도 있다.");
 		...
 		// x.y : x 와 y 사이에 임의의 문자가 올 수 있다.
 		System.out.println("x.y : x 와 y 사이에 임의의 한문자가 올 수 있다.");
 		
 		p = Pattern.compile("x.y");
 		System.out.println("xzy : "+p.matcher("xzy").find());
 		System.out.println("x0y : "+p.matcher("x0y").find());
 		System.out.println("xaay : "+p.matcher("xaay").find()); // 임의의 한글자만 가능
 		System.out.println("xy : "+p.matcher("xy").find());
 		System.out.println();
