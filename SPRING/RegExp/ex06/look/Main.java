...
public class Main {
	...
	public static void main(String[] args) {
		...
		// 부정형 전방 탐색 (?<!)
		// 뒤에서 부터 탐색해 나가 특정 패턴이 있는 것은 빼고 반환한다.
		m = Pattern.compile("\\b(?<![$])\\d+\\b").matcher(content);
		System.out.println("부정형 후방탐색");
		while (m.find()) {
			System.out.print(m.group()+" ");
		}
		System.out.println();
